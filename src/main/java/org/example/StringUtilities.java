...
public class StringUtilities {
    ...
    // characters
    public static boolean shortString(String param) {
    ...
    public static char firstLetter(String param) {
    ...
    public static String censorAsparagus(String param) {
        return param.replace("asparagus", "****");
    }
